import { buildWhatsAppUrl } from "./app-config.js?v=auth10";
...
const copy = {
  en: {
    ...
    answers: {
      ...
      payment: "Checkout is available at the end of your order.",
  ...
  pt: {
    ...
    answers: {
      ...
      payment: "O checkout fica disponivel no final da encomenda.",
  ...
  nl: {
    ...
    answers: {
      ...
      payment: "Checkout is beschikbaar aan het einde van je bestelling.",
  ...
  es: {
    ...
    answers: {
      ...
      payment: "El checkout esta disponible al final del pedido.",
  ...
  fr: {
    ...
    answers: {
      ...
      payment: "Le checkout est disponible a la fin de la commande.",
  ...
  de: {
    ...
    answers: {
      ...
      payment: "Checkout ist am Ende der Bestellung verfugbar.",
