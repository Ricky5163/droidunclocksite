import { escapeHtml, formatEuro, getCartCount, setupAdminLogoShortcut } from "./app-config.js?v=auth6";
import { logoutAndRedirect, requireAuth, supabase } from "./auth-utils.js?v=auth6";
